 ...
 */
export function generateWorktreeName(taskId) {
 ...
 */
export function getWorktreeBasePath(mainRepoPath, basePath) {
    if (basePath) {
        return basePath;
    }
 ...
 */
export async function commitAndPush(ctx, message, remote = 'origin') {
 ...
 */
export async function removeWorktree(ctx) {
 ...
 */
export async function worktreeExists(ctx) {
 ...
 */
export async function mergeToTarget(params) {
 ...
 */
export async function validateProtectedPaths(params) {
