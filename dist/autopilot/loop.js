 ...
 */
export function createLoopContext(settings) {
    return {
        settings,
        cycleCount: 0,
        startedAt: new Date(),
 ...
 */
export function recordCycle(ctx, result) {
    ctx.cycleCount++;
 ...
 */
export function formatCycleResult(result, cycleNumber) {
 ...
 */
export function formatStatus(ctx, running) {
